...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        ItemDetails(
            produk  = detailUIState.addEvent.toProduk(), modifier = Modifier.fillMaxWidth()
        )
...
@Composable
fun ItemDetails(
    produk: Produk, modifier: Modifier = Modifier
) {
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                labelResID ="Nama Barang",
                itemDetail = produk.namaProduk,
                modifier = Modifier.padding(
                    horizontal = 12.dp
                )
            )
            ItemDetailsRow(
                labelResID = "Jenis Barang",
                itemDetail = produk.jenisProduk,
                modifier = Modifier.padding(
                    horizontal = 12.dp
                )
            )
            ItemDetailsRow(
                labelResID ="Jumlah Barang",
                itemDetail = produk.jumlahProduk,
                modifier = Modifier.padding(
                    horizontal = 12.dp
                )
            )
            ItemDetailsRow(
                labelResID ="Harga Barang",
                itemDetail = produk.hargaProduk,
                modifier = Modifier.padding(
                    horizontal = 12.dp
                )
            )
